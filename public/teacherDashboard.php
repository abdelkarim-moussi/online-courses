...
<!-- Articles -->
<section class="w-full section text-[#111C2D] bg-white rounded-lg shadow-md sec5 active relative" id="courses">
    ...
    <button id="addnewart" class="bg-orange-200 px-3 py-1 text-sm rounded-md capitalize hover:bg-orange-300">add new course</button>
    </div>
